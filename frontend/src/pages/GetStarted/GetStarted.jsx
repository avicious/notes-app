  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-ghost px-6 font-sans">
      <div className="max-w-2xl text-center">
        ...
        <p className="text-lg md:text-xl text-carbon leading-relaxed mb-10 max-w-lg mx-auto">
        ...
        <button
          ...
          className="group relative inline-flex items-center justify-center px-8 py-4 font-semibold text-white transition-all duration-200 bg-accent font-pj rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 hover:bg-slate-800 active:scale-95 shadow-lg cursor-pointer"
        >
          Get Started
          <svg
      ...
      <footer className="absolute bottom-8 text-carbon text-sm">
